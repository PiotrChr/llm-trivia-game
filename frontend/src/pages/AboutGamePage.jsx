        ...
        <Row>
          <Col sm={12}>
            ...
            <p>
              ...
              facilitates the generation of trivia questions across an extensive
              range of categories. Furthermore, due to the integration with LLM,
              the game possesses the ability to translate questions to nearly
              any language and also ensures their validation and enhancement.
            </p>

            <p>
              The game architecture is comprised of both backend and frontend
              servers. It employs a consistent mechanism that inspects the game
              database to identify and subsequently translate any reported
              questions.
            </p>
            ...
            <ListGroup className="mb-4">
              ...
              <ListGroup.Item>
                The pre-built game database is already stocked with 50 questions
                per category (spanning 100 categories in total)
              </ListGroup.Item>
            </ListGroup>
