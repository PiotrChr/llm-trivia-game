              ...
              <Row className="px-3">
                <Form noValidate validated={validated} onSubmit={handleSubmit}> {/* use validated state here */}
                  ...
                  <Form.Check className='mt-3'>
                    <input className="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked readOnly/>
                    <label className="form-check-label" htmlFor="flexCheckDefault">
                      I agree the <a onClick={() => {}} className="text-dark font-weight-bolder">Terms and Conditions</a>
                    </label>
                  </Form.Check>
                  ...
                  <p className="text-sm mt-3 mb-3">Already have an account? <a href="#" onClick={() => navigate('/login')} className="text-dark font-weight-bolder">Sign in</a></p>
                </Form>
                {error && <p>{error}</p>}
              </Row>
            </div>
