  ...
  return (
    <>
      <Container className="position-sticky z-index-sticky top-0">
        <Row>
          <Col size={12}>
          <Navbar variant="none" expand="lg" className='blur blur-rounded top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4 px-2'>
            <Container fluid className='pe-0'>
              <Navbar.Brand href="/" className='font-weight-bolder ms-lg-0 ms-3'>
                LLM Trivia Game
              </Navbar.Brand>
              <Navbar.Toggle aria-controls="basic-navbar-nav" className='shadow-none ms-2'/>
                  ...
                  {user ? (
                    <>
                      <Dropdown className="me-5">
                        <Dropdown.Toggle variant="none" id="dropdown-basic" className='btn-round btn-sm mb-0 btn-outline-primary me-2'>
                      ...
                      <Dropdown>
                        <Dropdown.Toggle variant="none" id="dropdown-basic" className='btn-sm btn-round mb-0 me-1 bg-gradient-dark'>
                    ...
                    <>
                      <Nav.Item className='d-flex align-items-center'>
                        <a href="/login" className='btn btn-round btn-sm mb-0 btn-outline-primary me-2'>Login</a>
                      </Nav.Item>
                      <Nav.Item className='d-flex align-items-center'>
                        <a href="/signup" className='btn btn-sm btn-round mb-0 me-1 bg-gradient-dark'>Signup</a>
                      </Nav.Item>
                    </>
                  )}
                </Nav>
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-8 mb-4 mx-auto text-center">
            <a onClick={() => { navigate('/about_game') }} target="_blank" className="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
              About Game
            </a>
            <a onClick={() => { navigate('/about_author') }} target="_blank" className="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
              About Author
            </a>
            <a onClick={() => { navigate('/project_page') }} target="_blank" className="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
              Project Page
            </a>
          </div>
          <div className="col-lg-8 mx-auto text-center mb-4 mt-2">
            <a onClick={() => {}} target="_blank" className="text-secondary me-xl-4 me-4">
