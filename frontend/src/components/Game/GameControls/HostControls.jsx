...
const renderCustomizeGameControls = (handleLanguageChange, languages, language) => {
    return (
        <>
            {/* <CategorySelect
...
const renderInGameHostControls = (paused, handlePauseGame, handleResumeGame) => {
    return (
        <>
            {
                paused
...
export const HostControls = ({
    ...
    return (
        <>
            {
                !gameStarted && allReady && <StartGameButton handleStartGame={handleStartGame} />
            }
            {
                gameStarted && renderInGameHostControls(paused, handlePauseGame, handleResumeGame)
            }
            {
                gameModeName === 'Custom' && renderCustomizeGameControls(handleLanguageChange, languages, language)
            }
        </>
    )
}
